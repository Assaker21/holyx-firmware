...
#define BITMAP_EXPECTED_SIZE 2254
// ------------------------ Pin Assignments ------------------------
#define EPD_CS_PIN       22//4
#define EPD_DC_PIN       23//5
#define EPD_RESET_PIN    24//6
#define EPD_BUSY_PIN     25//7

#define EPD_SPI_SCK_PIN  28//2
#define EPD_SPI_MOSI_PIN 29//3
#define EPD_SPI_MISO_PIN 255
